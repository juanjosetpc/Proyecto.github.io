...
favo.addEventListener("click", function() {
  ...
  if (!favoritas.includes(idRutina)) {
    ...
    favo.setAttribute("aria-label", "haz click para eliminar esta rutina de tus favoritas");
    ...
    favo.setAttribute("aria-label", "haz click para añadir a tus favoritas esta rutina");

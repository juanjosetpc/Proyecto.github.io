...
modalClose.addEventListener("click",function () {tituloInput.value = '';descripcion.value = '';
lunes.checked = false;
...
{  
    const rutina = {titulo:tituloInput.value,descripcion:descripcion.value,lunes:lunes.checked ,martes:martes.checked,miercoles:miercoles.checked
